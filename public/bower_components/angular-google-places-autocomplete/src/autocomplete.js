...
var app = angular.module('google.places', []);
	 ...
	 */
	app.directive('gPlacesAutocomplete',
    ...
    app.directive('gPlacesAutocompleteDrawer', ['$window', '$document', function ($window, $document) {
        var TEMPLATE = [
    ...
    app.directive('gPlacesAutocompletePrediction', [function () {
        var TEMPLATE = [
    ...
    app.filter('highlightMatched', ['$sce', function ($sce) {
    ...
    app.filter('unmatchedTermsOnly', [function () {
    ...
    app.filter('trailingComma', [function () {
